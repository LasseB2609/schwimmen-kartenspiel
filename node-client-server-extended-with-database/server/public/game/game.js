class Game {
    constructor(players, gameId, connection) { //erwartet bei erstellen eines Game-Objekts, dass ein Array Players übergeben wird, mit den Parametern id und username
